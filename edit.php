			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						...
						<option value="Pendidikan Teknologi Informasi" <?php if($data['Program_Studi'] == 'Pendidikan Teknologi Informasi'){ echo 'selected'; } ?>>Pendidikan Teknologi Informasi</option>
